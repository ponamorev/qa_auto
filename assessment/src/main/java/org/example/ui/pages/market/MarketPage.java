...
public class MarketPage extends BasePage {
    ...
    private final By appliancesTabButton = By.xpath("//span[contains(text(),'Бытовая техника')]/parent::a");
    ...
    public void clickCompareButton() {
        try {
            ...
            LogToAllure.logWarn("Can't click element {} because of: {}", compareButton, e.getMessage());
    ...
    public void clickAppliancesTabButton() {
        getClickableElement(appliancesTabButton).click();
    }
}
